...
## Tools
We use linters as well as prettier to enforce a number of coding guidelines. Refer to our [tslint.json](tslint.json) example and our [prettier config](.prettierrc) for specific details.
